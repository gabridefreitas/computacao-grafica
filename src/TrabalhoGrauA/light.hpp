...
const Distance LIGHT_DIST_20 = {
    .constant = 1.0, .linear = 0.22, .quadratic = 0.20};

const Distance LIGHT_DIST_13 = {
    .constant = 1.0, .linear = 0.35, .quadratic = 0.44};

const std::vector<Distance> LIGHT_DISTANCES = {
    LIGHT_DIST_3250, LIGHT_DIST_600, LIGHT_DIST_325, LIGHT_DIST_200,
    LIGHT_DIST_160,  LIGHT_DIST_100, LIGHT_DIST_65,  LIGHT_DIST_50,
    LIGHT_DIST_32,   LIGHT_DIST_20,  LIGHT_DIST_13,  LIGHT_DIST_7};
